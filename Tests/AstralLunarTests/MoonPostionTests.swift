...
final class MoonPostionTests: XCTestCase {
  ...
  func test_moon_position() {
    ...
    XCTAssertEqual(
      moonPosition(jd2000: jd2000),
      AstralBodyPosition(right_ascension: -1.9638999378692186, declination: -0.4666623303219141, distance: 56.55564052259119))
    ...
    XCTAssertEqual(
      moonPosition(jd2000: jd2000),
      AstralBodyPosition(right_ascension: -3.932462849957415, declination: 0.24034553813386558, distance: 57.76236323127602))
  }
