...
final class LocationInfoTests: XCTestCase {
  ...
  func test_bad_latitude() {
    XCTAssertThrowsError(try LocationInfo(name: "A place", region: "Somewhere", timezone: "Europe/London", latitudeStr: "i", longitudeStr: "2"))
  }

  func test_bad_longitude(){
    XCTAssertThrowsError(try LocationInfo(name: "A place", region: "Somewhere", timezone: "Europe/London", latitudeStr: "2", longitudeStr: "i"))
  }
