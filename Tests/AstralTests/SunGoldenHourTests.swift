...
final class SunGoldenHourTests: XCTestCase {
  ...
  func testGoldenHourMorning() throws {
    ...
    for (day, gh) in data {
      ...
      let (start2, end2) = try golden_hour(observer: Observer.new_dheli,
                                           date: day,
  ...
  func testGoldenHourEvening() throws {
    ...
    for (day, gh) in data {
      ...
      let (start2, end2) = try golden_hour(observer: Observer.london,
                                           date: day,
  ...
  func testBluenHourMorning() throws {
    ...
    for (day, bh) in data {
      ...
      let (start2, end2) = try blue_hour(observer: Observer.london,
                                         date: day,
                                         direction: SunDirection.rising
      )
