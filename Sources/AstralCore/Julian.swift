...
public func julianDay(at: DateComponents, calendar: Calendar = .init(identifier: .gregorian)) -> Double {
...
public func julianDay2000(at dateComponent: DateComponents) -> Double {
